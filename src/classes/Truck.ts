...
class Truck extends Vehicle { // TODO: Declare properties of the Truck class
  vin: string;
  color: string;
  make: string;
  model: string;
  ...
  constructor(
    ...
    super(); // The constructor calls the constructor of the parent class, Vehicle
    this.vin = vin;
    this.color = color;
    this.make = make;
    this.model = model;
  ...
  tow(vehicle: Truck | Motorbike | Car): void {
    ...
    if ('make' in vehicle && 'model' in vehicle) {
      ...
      console.log(`Towing unknown vehicle`);
    }
